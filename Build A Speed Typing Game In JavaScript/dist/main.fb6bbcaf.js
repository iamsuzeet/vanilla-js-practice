...
window.addEventListener("DOMContentLoaded", init); //Globals
//Available levels
...
var lvlSelection = document.querySelector("#lvlSelection").value;
var words = ["hat", "river", "lucky", "sujit", "rohan", "naruto", "sasuke", "jaypark", "establishment", "hero", "javascript", "learning", "echo", "nutrition", "prospective", "integration", "establishment", "bayern", "realmadrid", "revolver", "bizon", "assaultrifle", "generate", "statue", "cocktail", "stubborn"]; //init the game

function init() {
  //show number of seconds
  seconds.innerHTML = currentLevel; //load word from array

  showWord(words); //start matching on word input
...
function showWord(words) {
  ...
  var randIndex = Math.floor(Math.random() * words.length); //output a random word
